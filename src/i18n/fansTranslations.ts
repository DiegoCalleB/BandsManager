...
const cs: FanFormDict = {
  ...
  economicSupportTitle: 'Podpoř {bandName} finančním příspěvkem',
  economicSupportSubtitle: 'Tvoje dobrovolná podpora nám pomáhá přímo financovat nahrávání ve studiu, dodávku na turné, nástroje a provoz kapely.',
