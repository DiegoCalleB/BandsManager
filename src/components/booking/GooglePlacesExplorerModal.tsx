...
export function GooglePlacesExplorerModal({
  ...
  const handleSearch = async (overrideQuery?: string, overrideCity?: string) => {
    ...
    if (cityToUse.trim() && !q.toLowerCase().includes(cityToUse.toLowerCase().trim())) {
            ...
            <div className="flex flex-col md:flex-row gap-2">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Ej. Salas de conciertos, Festivales, Teatros..."
              ...
              <div className="relative w-full md:w-52">
                ...
                <input
                  ...
                  onKeyDown={e => e.key === 'Enter' && handleSearch()}
                  placeholder="Ciudad (ej. Segovia, Granada...)"
                  className="w-full pl-9 pr-3 py-2 text-xs rounded-xl bg-zinc-950 border border-zinc-800 text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-[#f2ca50]"
                />
                {selectedCity && (
                  <button
              ...
              <button
                ...
                className="px-4 py-2 bg-[#f2ca50] hover:bg-[#d8b03e] text-[#2c2200] font-bold text-xs rounded-xl flex items-center justify-center gap-2 transition-all shadow-md cursor-pointer disabled:opacity-50 shrink-0"
              >
